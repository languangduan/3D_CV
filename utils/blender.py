...
ext = os.path.splitext(args.obj)[1].lower()
if ext == '.obj':
...
# os.path.join(os.path.abspath(args.output_folder), model_identifier, model_identifier)
